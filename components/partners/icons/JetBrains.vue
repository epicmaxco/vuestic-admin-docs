<template>
  <svg fill="none" width="100" height="100" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg">
...
import {useSponsorIcon} from "~/components/partners/icons/composables";
